...
- (void)drawRect:(CGRect)rect {
  ...
  switch (globalPicture) {
    case head:
      [array2 addObjectsFromArray:[self drawHead]];
      [self.array addObjectsFromArray:[self drawHead]];
      break;
    case tree:
      [self.array addObjectsFromArray:[self drawTree]];
      break;
    case landscape:
      [self.array addObjectsFromArray:[self drawLandscape]];
      break;
    case planet:
      [self.array addObjectsFromArray:[self drawPlanet]];
      break;
  }

  UIColor* strokeColor = colors[0];
  [strokeColor setStroke];
  UIBezierPath* bezierPath = self.array[0];
  ...
  UIColor* strokeColor2 = colors[1];
  UIBezierPath* bezier2Path = self.array[1];
